...
dataset_items, cell_line_mapping, num_cell_lines = load_dataset_from_csv('data/processed/generation_train_dataset_formatted.csv')
CONDITION_DIM = 1 + num_cell_lines
...
# -----------------------
save_path = "models/cpp_soft_prompt_model_active_learning.pt"
torch.save({
...
with open('models/cell_line_mapping.json', 'w') as f:
    json.dump(cell_line_mapping, f, indent=2)
print("Saved cell line mapping to models/cell_line_mapping.json")